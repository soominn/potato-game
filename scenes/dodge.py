...
class DodgeScene:
    def __init__(self, W, H):
        ...
        self.player_image = pygame.transform.scale(
            pygame.image.load("./images/player.png").convert_alpha(), (45, 70)
        )
        self.potato_image = pygame.transform.scale(
            pygame.image.load("./images/poisonous_potato.png").convert_alpha(), (30, 23)
        )
    ...
    def draw(self, screen):
        ...
        text_avoided = self.font.render(f"피한 개수: {self.avoided}", True, (20, 20, 20))
        text_time = self.font.render(f"생존 시간: {self.elapsed:.2f}s", True, (20, 20, 20))
        screen.blit(self.hint, (hud_left, hud_top))
        screen.blit(text_avoided, (hud_left, hud_top + gap))
        screen.blit(text_time, (hud_left, hud_top + 2 * gap))
    ...
    def _run_game_over_modal(self, screen):
        ...
        self._draw_text_center(screen, f"피한 개수 : {self.avoided}", self.font, (50, 50, 50), top + 140)
        self._draw_text_center(screen, f"생존 시간 : {self.elapsed:.2f}초", self.font, (50, 50, 50), top + 180)
        self._draw_text_center(screen, "R: 재시작   |   ESC: 메뉴", self.hint_font, (90, 90, 90), top + 250)
        pygame.display.flip()
